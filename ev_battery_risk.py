        ...
        for t in range(N_SLOT):
            ...
            for i_st, st_ in enumerate(stalli):
                ...
                if not attivo:
                    ...
                    # Tipo A: sistema non soddisfa auto veloce (con soglie)
                    if (kw_ass < kw_richiesto
                            and kw_richiesto > kw_soglia_auto
                            and kw_ass < kw_soglia_sistema
                    ...
                    def3 = max(0.0, kw_richiesto      - kw_ass) * SLOT_H
                    def4 = max(0.0, st_['kw_max'] - kw_ass) * SLOT_H
                    kwh_def3[i_st] += def3
                    kwh_def4[i_st] += def4
